...
module.exports.APPLICATION_COMMAND_GLOBAL =                              (appID) => `/applications/${appID}/commands`;
module.exports.APPLICATION_COMMAND_GUILD =                      (appID, guildID) => `/applications/${appID}/guilds/${guildID}/commands`;
module.exports.APPLICATION_COMMAND_GLOBAL_SELECT =            (appID, commandID) => `/applications/${appID}/commands/${commandID}`;
module.exports.APPLICATION_COMMAND_GUILD_SELECT =    (appID, guildID, commandID) => `/applications/${appID}/guilds/${guildID}/commands/${commandID}`;
