...
module.exports.AuditLogActions = {
    ...
    VOICE_CHANNEL_STATUS_CREATE: 192, VOICE_CHANNEL_STATUS_UPDATE: 192, // [DEPRECATED]
...
module.exports.EmbedFlags = {
    IS_CONTENT_INVENTORY_ENTRY: 1 << 5
};

module.exports.EmbedMediaFlags = {
    IS_ANIMATED: 1 << 5
};
...
module.exports.InviteUpdateJobStatus = {
    UNSPECIFIED: 0,
    PROCESSING:  1,
    COMPLETED:   2,
    FAILED:      3
...
module.exports.SeparatorSpacingSize = {
    SMALL: 1,
    LARGE: 2
};
...
module.exports.UnfurledMediaItemFlags = {
    IS_ANIMATED: 1 << 0
};
