    ...
    static from(data, client) {
        switch(data.type) {
            ...
            case ChannelTypes.DM: {
                // Not needed and not used, user DM
                return;
            }
            ...
            case ChannelTypes.GROUP_DM: {
                // Not needed and not used, group DM
                return;
            }
            ...
            case ChannelTypes.GUILD_STORE: {
                // Has been removed, doesn't exists anymore
                return;
            }
            case ChannelTypes.GUILD_NEWS_THREAD: {
                // Not used, and no support in any counters
            ...
            case ChannelTypes.GUILD_FORUM: {
                // Forum channels is out but no support has been added
                return;
            }
            case ChannelTypes.GUILD_MEDIA: {
                // Media channels is still in closed beta
                return;
            }
        }
        if(data.guild_id) {
