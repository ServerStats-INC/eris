...
/**
* Represents an interaction. You also probably want to look at PingInteraction, CommandInteraction, ComponentInteraction and AutocompleteInteraction.
...
class Interaction extends Base {
    constructor(data, client) {
        ...
        if(data.entitlements !== undefined) {
            /**
             * The entitlements of the user invoking the interaction
             * @type {Array<Entitlement>}
             */
            this.entitlements = data.entitlements.map((entitlement) => new Entitlement(entitlement, client));
        }
    }
