...
/**
* Represents a guild channel. You also probably want to look at CategoryChannel, NewsChannel, TextChannel, and VoiceChannel. See Channel for extra properties.
* @extends Channel
...
class GuildChannel extends Channel {
    ...
    */
    editPosition(position, options) {
        return this.client.editChannelPosition.call(this.client, this.id, this.guild, position, options);
    }
