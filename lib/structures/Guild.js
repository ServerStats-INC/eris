...
class Guild extends Base {
    ...
    async fillBotsSet(setSetting) {
        if(setSetting) this.cacheSettings.hasSetup = true;
        if(this.cacheSettings.hasSetup) {
    ...
    async fillStatusSet(setSetting) {
        if(setSetting) this.cacheSettings.hasStatus = true;
        if(this.cacheSettings.hasStatus) {
    ...
    async fillActivitiesSet(setSetting) {
        if(setSetting) this.cacheSettings.hasActivities = true;
        if(this.cacheSettings.hasActivities) {
            if(!this.membersCache) this.membersCache = new Collection(MemberCache);
            if(!this.hasCached.members || this.members.size < 2) {
                if(this.membersCache.size > 0) this.membersCache.wipe();
    ...
    async fillPendingSet(setSetting) {
        if(setSetting) this.cacheSettings.hasPending = true;
        if(this.cacheSettings.hasPending) {
    ...
    async fillNoRoleCache(setSetting) {
        if(setSetting) this.cacheSettings.hasNoRole = true;
        if(this.cacheSettings.hasNoRole) {
            if(!this.membersCache) this.membersCache = new Collection(MemberCache);
            if(!this.hasCached.members || this.members.size < 2) {
                if(this.membersCache.size > 0) this.membersCache.wipe();
    ...
    async fillRoleCache(roles) {
        ...
        if(this.cacheSettings.roleCounter.size > 0) {
            if(!this.membersCache) this.membersCache = new Collection(MemberCache);
            if(!this.hasCached.members || this.members.size < 2) {
                if(this.membersCache.size > 0) this.membersCache.wipe();
