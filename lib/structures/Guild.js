...
class Guild extends Base {
    ...
    async fillBotsSet(setSetting) {
        ...
        // Add and fill bots set so we can created member and bot count
    ...
    async fillPendingSet(setSetting) {
        ...
        // Add and fill pending set so we can created pending count
    ...
    async fillRoleCache(roles, action) {
        ...
        if(this.cacheSettings.roleCounter.size === 0) {
            if(this.membersCache) this.membersCache.wipe();
            return;
        }
