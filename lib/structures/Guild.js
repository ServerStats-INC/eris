...
class Guild extends Base {
    constructor(data, client) {
        super(data.id);
        this._client = client;
        this.shard = client.shards.get(typeof client.guildShardMap[this.id] !== "undefined" ? client.guildShardMap[this.id] : (Base.getDiscordEpoch(data.id) % client.options.maxShards));
