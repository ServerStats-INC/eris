...
class Client extends EventEmitter {
    ...
    */
    async connect() {
        try {
            ...
            this.gatewayURL = `${data.url}?v=${Constants.GATEWAY_VERSION}&encoding=json`;
    ...
    */
    editRolePosition(guildID, roleID, position) {
		...
		if (!guildData) {
			return Promise.reject(new Error(`Guild (${guildID}) with role ${roleID} not found`));
		}
    ...
    */
    ...
    /**
    * Send a get request to get all slahs command form a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    * @returns {Promise}
    */
    getGuildInteraction(appID, guildID) {
        return this.requestHandler.request("GET", Endpoints.APPLICATION_COMMAND_GUILD(appID, guildID), true);
    }

    /**
    * Send a post request to create a slash command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID of the guild you want to create the command for.
    * @arg {Object} command The slash command object.
    * @arg {Number} command.name 1-32 lowercase character name matching ^[\w-]{1,32}$.
    * @arg {Number} command.description 1-100 character description.
    * @arg {Array} [command.options] the parameters for the command.
    * @arg {Boolean} [default_permission] whether the command is enabled by default when the app is added to a guild.
    * @returns {Promise}
    */
    createGuildInteraction(appID, guildID, options) {
        return this.requestHandler.request("POST", Endpoints.APPLICATION_COMMAND_GUILD(appID, guildID), true, options);
    }

    /**
    * Send a patch request to update a slahs command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    * @arg {String} commandID The ID from the command you want to modify.
    * @arg {Object} command The slash command object.
    * @arg {Number} command.name 1-32 lowercase character name matching ^[\w-]{1,32}$.
    * @arg {Number} command.description 1-100 character description.
    * @arg {Array} [command.options] the parameters for the command.
    ...
    * @returns {Promise}
    */
    updateGuildInteraction(appID, guildID, commandID, options) {
        return this.requestHandler.request("PATCH", Endpoints.APPLICATION_COMMAND_GUILD_SELECT(appID, guildID, commandID), true, options);
    }

    /**
    * Send a delete request to remove a slahs command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    * @arg {String} commandID The ID from the command you want to modify.
    * @returns {Promise}
    */
    deleteGuildInteraction(appID, guildID, commandID) {
        return this.requestHandler.request("DELETE", Endpoints.APPLICATION_COMMAND_GUILD_SELECT(appID, guildID, commandID), true);
    }

    /**
    * Send a get request to get all global slahs command.
    * @arg {String} appID The ID from the bot.
    * @returns {Promise}
    */
    getGlobalInteraction(appID) {
        return this.requestHandler.request("GET", Endpoints.APPLICATION_COMMAND_GLOBAL(appID), true);
    }
    
    /**
    * Send a post request to create a global slahs command.
    * @arg {String} appID The ID from the bot.
    * @arg {Object} command The slash command object.
    * @arg {Number} command.name 1-32 lowercase character name matching ^[\w-]{1,32}$.
    * @arg {Number} command.description 1-100 character description.
    ...
    * @returns {Promise}
    */
    createGlobalInteraction(appID, options) {
        return this.requestHandler.request("POST", Endpoints.APPLICATION_COMMAND_GLOBAL(appID), true, options);
    }
    
    /**
    * Send a patch request to update a global slahs command.
    * @arg {String} appID The ID from the bot.
    * @arg {String} commandID The ID from the command you want to modify.
    * @arg {Object} command The slash command object.
    * @arg {Number} command.name 1-32 lowercase character name matching ^[\w-]{1,32}$.
    ...
    * @returns {Promise}
    */
    updateGlobalInteraction(appID, commandID, options) {
        return this.requestHandler.request("PATCH", Endpoints.APPLICATION_COMMAND_GLOBAL_SELECT(appID, commandID), true, options);
    }
    
    /**
    * Send a delete request to remove a global slahs command.
    * @arg {String} appID The ID from the bot.
    * @arg {String} commandID The ID from the command you want to modify.
    * @returns {Promise}
    */
    deleteGlobalInteraction(appID, guildID, commandID) {
        return this.requestHandler.request("DELETE", Endpoints.APPLICATION_COMMAND_GLOBAL_SELECT(appID, commandID), true);
    }
