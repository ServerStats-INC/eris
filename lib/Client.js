...
class Client extends EventEmitter {
    ...
    */
    ...
    /**
    * Send a get requiest to get all slahs command form a server.
    ...
    */
    ...
    /**
    * Send a post requiest to create a slahs command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    ...
    */
    ...
    /**
    * Send a patch requiest to update a slahs command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    ...
    */
    ...
    /**
    * Send a delete requiest to remove a slahs command in a server.
    * @arg {String} appID The ID from the bot.
    * @arg {String} guildID The ID from the you want to create the command for.
    * @arg {String} commandID The ID from the command you want to modify.
    * @returns {Promise}
