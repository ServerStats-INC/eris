...
class Client extends EventEmitter {
    ...
    * @arg {Object} [options.enabledEvents] If enabledEvents[eventName] is true, the WS event will not be processed. This can cause significant performance increase on large bots. [A full list of the WS event names can be found on the docs reference page](/Eris/docs/reference#ws-event-names)
    ...
    */
    constructor(token, options) {
        ...
        this.options.enabledEvents["READY"] = true;
        this.options.enabledEvents["RESUMED"] = true;
        this.options.enabledEvents["GUILD_CREATE"] = true;
