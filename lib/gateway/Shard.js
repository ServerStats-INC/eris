            ...
            case "GUILD_MEMBERS_CHUNK": {
                ...
                if(packet.d.chunk_index >= packet.d.chunk_count - 1) {
                    if(this.requestMembersPromise.hasOwnProperty(packet.d.nonce)) {
                        ...
                        const newCount = guild.savedCount.cache !== guild.savedCount.chunk ? guild.savedCount.chunk : guild.savedCount.cache;
                        if(newCount >= 2 && guild.memberCount !== newCount) {
                            if(Math.abs(guild.memberCount - newCount) <= getOffset(newCount) || newCount > guild.memberCount) {
