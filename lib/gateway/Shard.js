    ...
    */
    ...
    onPacket(packet) {
        ...
        switch(packet.op) {
            case GatewayOPCodes.DISPATCH: {
                if(!this.client.options.enabledEvents[packet.t]) {
                    break;
                }
    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            // Do cache users if the guild has fetched, maybe add something to the guild of they aren't sleeping
